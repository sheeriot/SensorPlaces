...
urlpatterns = [
    ...
    # Toast API endpoint
    path('api/<slug:place_slug>/toasts/', 
         views.ToastAPIView.as_view(), 
         name='toast_api'),
         
    # Toggle active endpoint
    path('api/<slug:place_slug>/toggle-active/', 
         views.ToggleActiveView.as_view(), 
         name='toggle_active'),
    ...
    # path('api/<slug:place_slug>/toast-read/', views.mark_toast_read, name='mark_toast_read'),
    # path('api/<slug:place_slug>/toast-mark-all-read/', views.mark_all_toasts_read, name='mark_all_toasts_read'),
