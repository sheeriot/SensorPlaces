...
urlpatterns = [
    ...
    path('<slug:slug>/update/', views.PlaceUpdateView.as_view(), name='place_update'),
    path('<slug:slug>/delete/', views.PlaceDeleteView.as_view(), name='place_delete'),
    path('place/<slug:slug>/update_site_plan_layout/', views.update_site_plan_layout, name='update_site_plan_layout'),
    ...
    # Device URLs - nested under places
    ...
    path('<slug:place_slug>/location/<int:location_pk>/device/<int:pk>/', views.DeviceDetailView.as_view(), name='device_detail'),
    path('<slug:place_slug>/location/<int:location_pk>/device/<int:pk>/update/', views.DeviceUpdateView.as_view(), name='device_update'),
    path('<slug:place_slug>/location/<int:location_pk>/device/<int:pk>/delete/', views.DeviceDeleteView.as_view(), name='device_delete'),
    
    # Sensor URLs - nested under places
    path('<slug:place_slug>/sensors/', views.SensorListView.as_view(), name='place_sensors'),
    path('<slug:place_slug>/location/<int:location_pk>/device/<int:device_pk>/sensor/create/', views.SensorCreateView.as_view(), name='sensor_create'),
    path('<slug:place_slug>/location/<int:location_pk>/device/<int:device_pk>/sensor/<int:pk>/', views.SensorDetailView.as_view(), name='sensor_detail'),
    path('<slug:place_slug>/location/<int:location_pk>/device/<int:device_pk>/sensor/<int:pk>/update/', views.SensorUpdateView.as_view(), name='sensor_update'),
    path('<slug:place_slug>//location/<int:location_pk>/device/<int:device_pk>/sensor/<int:pk>/delete/', views.SensorDeleteView.as_view(), name='sensor_delete'),
    ...
    path('api/<slug:place_slug>/sensors/<int:pk>/toggle_active/', 
         views.sensor_toggle_active, 
         name='sensor_toggle_active'),
